...
namespace ModernAuction
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var connectionString2 = builder.Configuration.GetConnectionString("AuctionDbContext") ?? throw new InvalidOperationException("Connection string 'AuctionDbContext' not found.");
